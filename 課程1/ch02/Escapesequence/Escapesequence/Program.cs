...
namespace Escapesequence
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("\t" + str1); //空8格在印str1字串後游標停在該行最後面
            //印完字串游標移到下一行最前面
            Console.Write("\nWelcome To VS \n");  //空一行由最左邊開始印字串，印
            //完游標移到下一行最前面
            Console.WriteLine("c:\\cs\\hw.cs"); //強迫字串中使用逃脫字元顯示倒斜線
            Console.WriteLine(@"c:\cs\hw.cs");  //使用@使得字串中的逃脫字元失效
            Console.WriteLine("\n\n" + "檔名:C:\\cs\\ex1.cs"); //空兩行再顯示檔案路徑
            Console.WriteLine("\n" + @"檔名:C:\cs\ex1.cs");  //空一行再顯示檔案路徑   

            Console.WriteLine("C#  is Cool !");      //字串顯示前後未加雙引號
            Console.WriteLine("\"C#  is Cool !\"");  //字串顯示前後加雙引號 

            string str2 = "\u0041pple"; // \u0041為字元’A’的UniCode，str2=”Apple”
            string str3 = "電腦";
